...
### `results/ml_teamwise_brier/{league}_winrates.csv`
...
### `results/ml_teamwise_brier/{league}_winrates.png`
...
### `results/ml_teamwise_brier/{league}.csv`
...
### `results/ml_teamwise_brier/{league}.png`
