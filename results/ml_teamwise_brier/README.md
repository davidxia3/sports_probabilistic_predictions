...
### `{league}.pdf`
This PDF file plots a bar chart for the specified league. The bar chart displays the Brier score of the moneyline based probabilistic predictions for each team in the league. The Brier score of a team is the Brier score of all games involving the team. The bars are sorted in ascending order.
